...
export const ONBOARDING_INFO = {
  ...
  onboarding_3: {
    ...
    description:
      'See every spot on the map, read simple fishing tips and a daily funny tip from the raccoon, then play a quick mini game anytime',
...
export const GAME_SCREEN_INFO = {
  image: ONBD_IMAGES.onbd2,
  description:
    'Catch it fast. Miss it… and you lose a life. Use the arrow buttons to move the raccoon and catch the item before time runs out',
  buttonText: 'Start',
};
